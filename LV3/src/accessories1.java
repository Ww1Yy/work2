public class accessories1 extends accessories{
    public accessories1(String accessories_name,int accessories_health,int accessories_defense,int accessories_charge,double accessories_critical_chance,double accessories_critical_hit){
