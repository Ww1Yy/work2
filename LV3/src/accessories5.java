public class accessories5 extends accessories{
    public accessories5(String accessories_name,int accessories_health,int accessories_defense,int accessories_charge,double accessories_critical_chance,double accessories_critical_hit){
